  ...
  return (
    <div className="container mx-auto my-10">
      <div className="flex lg:flex-row flex-col lg:gap-8">
        <div className="bg-[#efefef] lg:w-2/3 shadow-md rounded-xl p-4">
          ...
          <div className="flex flex-col mt-10 lg:mt-44 text-[#67645E] gap-4">
        ...
        <Image
          ...
          height={704}
          alt="Hailey Bieber"
          className="rounded-xl lg:w-[585px] md:w-full"
        />
      </div>
    </div>
  );
